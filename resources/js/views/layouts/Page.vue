    ...
    <div class="p-2 xl:px-0">
        ...
        <div class="flex flex-wrap justify-between mb-2">
            ...
            <div class="flex items-center" v-if="$props.actions.length > 0">
                <slot
                    v-for="(action, j) in $props.actions"
                    :name="'page-actions-' + action.id"
                >
                    <Button
                        ...
                        :title="action.name"
                        :icon="
                            action.hasOwnProperty('icon') ? action.icon : null
                        "
                        :theme="
                            action.hasOwnProperty('theme') ? action.theme : null
                        "
                        :label="action.name"
                    />
                    <Button
                        v-else
                        @click="onPageActionClick({ action: action })"
                        :class="{ 'mr-3': j < $props.actions.length - 1 }"
                        :title="action.name"
                        :icon="
                            action.hasOwnProperty('icon') ? action.icon : null
